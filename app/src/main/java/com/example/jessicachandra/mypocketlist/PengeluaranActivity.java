...
public class PengeluaranActivity extends AppCompatActivity {
    ...
    private void refreshList() {
        ...
        lvPengeluaran = (ListView) findViewById(R.id.lvpengeluaran);
        ...
        lvPengeluaran.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(PengeluaranActivity.this);
                ...
                builder.setItems(dialogitem, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        switch (item) {
                            case 0:
                                Intent i = new Intent(PengeluaranActivity.this, Input_Cash_Activity.class);
